...
static uae_u32 REGPARAM2 akiko_lget_bank (uaecptr addr) { return akiko_lget(addr); }
static uae_u32 REGPARAM2 akiko_wget_bank (uaecptr addr) { return akiko_wget(addr); }
static uae_u32 REGPARAM2 akiko_bget_bank (uaecptr addr) { return akiko_bget(addr); }
static void REGPARAM2 akiko_lput_bank (uaecptr addr, uae_u32 l) { akiko_lput(addr, l); }
static void REGPARAM2 akiko_wput_bank (uaecptr addr, uae_u32 w) { akiko_wput(addr, w); }
static void REGPARAM2 akiko_bput_bank (uaecptr addr, uae_u32 b) { akiko_bput(addr, b); }
static int REGPARAM2 akiko_check_bank (uaecptr addr, uae_u32 size) { return 1; }
static uae_u8 REGPARAM2 *akiko_xlate_bank (uaecptr addr) { return akiko_buffer; }

addrbank akiko_bank = {
    akiko_lget_bank, akiko_wget_bank, akiko_bget_bank,
    akiko_lput_bank, akiko_wput_bank, akiko_bput_bank,
    akiko_xlate_bank, akiko_check_bank, NULL, "Akiko"
};
