...
#define SAMPLE_HANDLER \
	{ \
		uae_u32 d0 = audio_channel_current_sample[0]; \
		uae_u32 d1 = audio_channel_current_sample[1]; \
		uae_u32 d2 = audio_channel_current_sample[2]; \
		uae_u32 d3 = audio_channel_current_sample[3]; \
