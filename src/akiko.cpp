...
uae_u8 *akiko_save_state(int *length)
{
    ...
    save_u32(audio_end);
    save_u32((uae_u32)(audio_phase & 0xffffffffu));
    save_u32((uae_u32)(audio_phase >> 32));
...
uae_u8 *akiko_restore_state(uae_u8 *source)
{
    ...
    audio_phase = (uae_u64)restore_u32();
    audio_phase |= ((uae_u64)restore_u32()) << 32;
