...
#define floppyterms extterms!=".adf" && extterms!=".ADF" && extterms!=".Adf" && extterms!=".adz" && extterms!=".ADZ" && extterms!=".Adz" && extterms!="f.gz" && extterms!="F.GZ" && extterms!=".bz2" && extterms!=".BZ2" && extterms!=".Bz2" && extterms!=".zip" && extterms!=".ZIP" && extterms!=".Zip" && extterms!=".RP9" && extterms!=".rp9" && extterms!=".ipf" && extterms!=".IPF" && extterms!=".Ipf"
...
public:
    ...
    void changeDir(const char * path) {
        ...
        DIR *dir = NULL;
        struct dirent *dent;
        if(path != NULL && strcmp(path, "drives") != 0)
            dir = opendir(path);
        if(dir != NULL) {
